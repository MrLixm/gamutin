...
class ElidingLabel(QtWidgets.QLabel):
    ...
    QLabel which will elide text too long to fit the widget.

    References:
        - [1] https://doc-snapshots.qt.io/qtforpython-5.15/overviews/qtwidgets-widgets-elidedlabel-example.html
        - [2] https://stackoverflow.com/a/67628976/13806195

    Args:

        text : Label text.
        mode :
            Specify where ellipsis should appear when displaying texts that don’t fit.
